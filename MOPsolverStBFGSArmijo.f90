subroutine StBFGSArmijo(n,m,x,l,u,scaleF,checkder,outiter,time,nfev,ngev,theta,inform)
	...
	real(kind=8) :: g(n),xprev(n),Fx(m),JFprev(m,n),phi0(m),gphi0(m)
  ...
  ! March of 2022.
	...
	1000 format(/,1X,'-------------------------------------------------------------------------------',/,1X,& 
					 '        Standard BFGS-Armijo method for Multiobjective Optimization            ',/,1X,& 
					 '-------------------------------------------------------------------------------')
